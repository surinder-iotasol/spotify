...
- Name: tests/listener-profile.spec.ts >> Accessibility and edge cases >> playlist card cover shows music note when no cover image
- Location: e2e/tests/listener-profile.spec.ts:660:7
...
Locator: getByTestId('playlist-card-pl-nocover')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('playlist-card-pl-nocover')
