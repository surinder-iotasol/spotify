...
- Name: tests/listener-profile.spec.ts >> Followed Artists Carousel — AC3 >> carousel renders placeholder for artists without avatars
- Location: e2e/tests/listener-profile.spec.ts:488:7
...
Locator: getByTestId('followed-artist-ap-nopic')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('followed-artist-ap-nopic')
