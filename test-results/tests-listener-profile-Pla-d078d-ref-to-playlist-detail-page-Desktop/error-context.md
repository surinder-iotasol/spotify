...
- Name: tests/listener-profile.spec.ts >> Playlist Card Navigation — AC2 >> playlist card anchor has correct href to playlist detail page
- Location: e2e/tests/listener-profile.spec.ts:211:7
...
Locator: getByTestId('playlist-card-pl-workout')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByTestId('playlist-card-pl-workout')
