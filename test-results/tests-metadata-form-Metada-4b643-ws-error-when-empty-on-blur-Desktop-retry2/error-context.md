...
- Name: tests/metadata-form.spec.ts >> MetadataEntryForm >> title field shows error when empty on blur
- Location: e2e/tests/metadata-form.spec.ts:37:7
...
Locator: getByText('Title is required.')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Title is required.')
...
- alert
- main:
  - heading "Upload a Track" [level=1]
  - paragraph: Share your music with the world.
  - text: Title(0/100)
  - textbox "Title(0/100)":
    - /placeholder: Track title
  - text: Genre
  - combobox "Genre": Select a genre
  - text: Description(0/500)
  - textbox "Description(0/500)":
