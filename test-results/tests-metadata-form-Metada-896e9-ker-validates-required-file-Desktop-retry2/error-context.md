...
- Name: tests/metadata-form.spec.ts >> MetadataEntryForm >> cover art picker validates required file
- Location: e2e/tests/metadata-form.spec.ts:112:7

# Error details

```
Error: locator.click: Error: strict mode violation: getByText('Electronic') resolved to 2 elements:
    1) <option value="ELECTRONIC">Electronic</option> aka locator('select')
    2) <span id="radix-:rc:">Electronic</span> aka getByLabel('Electronic').getByText('Electronic')

Call log:
  - waiting for getByText('Electronic')
