...
- Name: tests/listener-profile.spec.ts >> Followed Artists Carousel — AC3 >> carousel is responsive on mobile viewport
- Location: e2e/tests/listener-profile.spec.ts:548:7
