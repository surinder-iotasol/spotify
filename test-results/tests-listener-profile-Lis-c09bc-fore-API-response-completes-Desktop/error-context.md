...
- Name: tests/listener-profile.spec.ts >> Listener Profile — Page Load (AC1) >> renders loading state before API response completes
- Location: e2e/tests/listener-profile.spec.ts:143:7
