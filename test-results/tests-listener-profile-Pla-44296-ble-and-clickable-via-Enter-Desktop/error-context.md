...
- Name: tests/listener-profile.spec.ts >> Playlist Card Navigation — AC2 >> playlist card is keyboard-focusable and clickable via Enter
- Location: e2e/tests/listener-profile.spec.ts:292:7
